...
ActiveRecord::Schema.define(version: 20170420162952) do
  ...
  create_table "books_genres_joins", force: :cascade do |t|
    t.integer "book_id"
    t.integer "genre_id"
    t.index ["book_id"], name: "index_books_genres_joins_on_book_id", using: :btree
    t.index ["genre_id"], name: "index_books_genres_joins_on_genre_id", using: :btree
  end
